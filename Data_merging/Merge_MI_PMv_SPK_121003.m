...
load('spks_SPK_MI_121003.mat');
spks_MI=Spikes;  clear var Spikes

load('spks_SPK_PMv_121003.mat')
spks_all=spks_MI;
for k=1:96
...
save('SPK_all_121003_250','Data_all','spks_all')
