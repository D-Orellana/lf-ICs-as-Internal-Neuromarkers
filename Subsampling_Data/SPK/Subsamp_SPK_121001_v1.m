...
disp('Subsampling SPK121001...')
name_2_save=strcat('SPK121001_',num2str(30000/subsamp_factor));


%% Load events MI_PMd and PMv
file_MI_PMd='SPK121001_MI_PMd_TT_SEQSIM\SPK121001_MI_PMd_TT_SEQSIM001.ns5';
MI_PMd_events=load([datadir 'SPK121001_MI_PMd_TT_SEQSIM\derived\SPK121001_MI_PMd_TT_SEQSIM001_ev_explicit.mat'],'ev_ex');

file_PMv='SPK121001_PMv_TT_SEQSIM\SPK121001_PMv_TT_SEQSIM001.ns5';
PMv_events= load([datadir 'SPK121001_PMv_TT_SEQSIM\derived\SPK121001_PMv_TT_SEQSIM001_ev_explicit.mat'],'ev_ex');
