...
disp('Subsampling SPK121004...')
name_2_save=strcat('SPK121004_',num2str(30000/subsamp_factor));


%% Load events MI_PMd and PMv
file_MI_PMd='SPK121004_MI_PMd_TT_SEQSIM\SPK121004_MI_PMd_TT_SEQSIM001.ns5';
MI_PMd_events=load([datadir 'SPK121004_MI_PMd_TT_SEQSIM\derived\SPK121004_MI_PMd_TT_SEQSIM001_ev_explicit.mat'],'ev_ex');

file_PMv='SPK121004_PMv_TT_SEQSIM\SPK121004_PMv_TT_SEQSIM001.ns5';
PMv_events= load([datadir 'SPK121004_PMv_TT_SEQSIM\derived\SPK121004_PMv_TT_SEQSIM001_ev_explicit.mat'],'ev_ex');
