...
%% Loading Data
load('SPK121001_250.mat')                        % Subsampled Data
load('W_ICA_SPK121001_250.mat')        % Unmixing matrix

%% Filtering and ICA
Data_filt=(filtfilt(bandpass_filt,Data'))';
...
file2load='SPK121001_250.mat';
w2load='W_ICA_SPK121001_250.mat';
selected_ICs=[5 101 20 3 13 16 4];
[spk_s1]=extract_IC_peaks(file2load, w2load, selected_ICs,0);

file2load='SPK121003_250.mat';
w2load='W_ICA_SPK121003_250.mat';
selected_ICs=[13 36 18 2 19 25 5];
[spk_s2]=extract_IC_peaks(file2load, w2load, selected_ICs,0);

file2load='SPK121004_250.mat';
w2load='W_ICA_SPK121004_250.mat';
selected_ICs=[13 38 17 3 21 14 4];
[spk_s3]=extract_IC_peaks(file2load, w2load, selected_ICs,0);

file2load='SPK121005_250.mat';
w2load='W_ICA_SPK121005_250.mat';
selected_ICs=[27 32 23 5 22 31 17];
[spk_s4]=extract_IC_peaks(file2load, w2load, selected_ICs,0);

file2load='SPK121005_250.mat';
w2load='W_ICA_SPK121107_250.mat';
selected_ICs=[7 26 17 24 21 59 32];
[spk_s5]=extract_IC_peaks(file2load, w2load, selected_ICs,0);

file2load='RUS120618_250.mat';
w2load='W_ICA_RUS120618_250.mat';
selected_ICs=[7 11 2 4 5 16 21];
[rus_s1]=extract_IC_peaks(file2load, w2load, selected_ICs,0);

file2load='RUS120619_250.mat';
w2load='W_ICA_RUS120619_250.mat';
selected_ICs=[12 6 5 3 8 11 44];
[rus_s2]=extract_IC_peaks(file2load, w2load, selected_ICs,0);

file2load='RUS120622_250.mat';
w2load='W_ICA_RUS120622_250.mat';
selected_ICs=[7 12 6 10 11 23 26];
[rus_s3]=extract_IC_peaks(file2load, w2load, selected_ICs,0);

file2load='RUS120627_250.mat';
w2load='W_ICA_RUS120627_250.mat';
selected_ICs=[20 9 6 8 10 17 50];
[rus_s4]=extract_IC_peaks(file2load, w2load, selected_ICs,0);

file2load='RUS120702_250.mat';
w2load='W_ICA_RUS120702_250.mat';
selected_ICs=[16 8 14 11 13 27 38]; 
[rus_s5]=extract_IC_peaks(file2load, w2load, selected_ICs,0);
