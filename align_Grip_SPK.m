...
function  align_results=align_Grip_SPK(data_folder,file2load, w2load, grip_IC,chs2align)
...
for kch=1:numel(chs2align)
        ...
        for k=1:numel(labels_exe)
            ...
            ini=round((events_exe(k,2)-0.1)*fs_raw);
            fin=ini + round(1.5*fs_raw);
