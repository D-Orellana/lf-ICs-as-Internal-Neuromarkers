...
function  align_results=align_Obj_RUS(data_folder,file2load, w2load, obj_IC,chs2align)
...
for kch=1:numel(chs2align)
        ...
        for k=1:numel(labels_exe)
            ini=round((locs_obj(k)-0.42)*fs_raw);
