...
fso=30000;
N=100;
load('D:\LFP_spikes_analisys\RUS_120618\RUS_all_120618_250.mat')
load('D:\LFP_spikes_analisys\RUS_120618\W_ICA_RUS120618_250.mat')
load('prefered_chs_RUS_120618.mat')

exe_chs=prefered_chs.execution;
% bch=[5 6 9 10 16 18 19 37 38 48 52 53 55];
%  exe_chs(bch)=[];
...
for k=1:numel(labels_exe)
    ...
    fin=round((ref+1.0)*fs);               % 700ms after external marker
