...
fso=30000;
N=10;
load('D:\LFP_spikes_analisys\RUS_120622\RUS_all_120622_250.mat')
load('D:\LFP_spikes_analisys\RUS_120622\W_ICA_RUS120622_250.mat')
load('prefered_chs_RUS_120622.mat')

grip_chs=prefered_chs.grip;
grip_chs=[8 58 100 119 133 135 161 162 163 165 166 ];
Data=(Data_all.Data)';
    ...
    kch
       ch_id=grip_chs(kch);
        ...
        for k=1:numel(labels_exe)
            ...
            ini=round((events_exe(k,2)+0.31)*fso);
            fin=ini + round(0.7*fso);
