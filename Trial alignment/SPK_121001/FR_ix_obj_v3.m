...
fso=30000;
N=100;
load('D:\LFP_spikes_analisys\SPK_121001\SPK_all_121001_250.mat')
load('D:\LFP_spikes_analisys\SPK_121001\W_ICA_SPK121001_250.mat')
load('prefered_chs_SPK_121001.mat')

obj_chs=prefered_chs.object;
obj_chs=[6 9 15 46 62 72 75 77 103 105 108 109 110 111 112 116 117 130 135 137 140 143 145 147 150 163 164 166 167 173];
