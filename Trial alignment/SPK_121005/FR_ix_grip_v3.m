...
fso=30000;
N=1;
load('D:\LFP_spikes_analisys\SPK_121005\SPK_all_121005_250.mat')
load('D:\LFP_spikes_analisys\SPK_121005\W_ICA_SPK121005_250.mat')
load('prefered_chs_SPK_121005.mat')

grip_chs=prefered_chs.grip;
grip_chs=[9 71 112 121 150];
...
for kch=1:numel(grip_chs)
    kch
       ch_id=grip_chs(kch);
        ...
        for k=1:numel(labels_exe)
            ini=round((locs_grip(k)-0.38)*fso);
