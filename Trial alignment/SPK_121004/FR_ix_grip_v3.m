...
fso=30000;
N=100;
load('D:\LFP_spikes_analisys\SPK_121004\SPK_all_121004_250.mat')
load('D:\LFP_spikes_analisys\SPK_121004\W_ICA_SPK121004_250.mat')
load('prefered_chs_SPK_121004.mat')

grip_chs=prefered_chs.grip;
grip_chs=[6 9 71 77 107 109 110 112 113 121 125 135 138 150 161 167];
Data=(Data_all.Data)';
