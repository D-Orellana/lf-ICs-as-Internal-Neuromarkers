...
clear vars a b bandpass_filt Data Data_all  events_exe events_ob fc1 fc2 FPR IC ICs k incomplete_evs spks_all t th Th_opt W
clear vars labels_exe  labels_ob p_mean r_mean p_std r_mean r_std Prec_opt Rec_opt presicion recall  TH_opt TPR ep er fs
