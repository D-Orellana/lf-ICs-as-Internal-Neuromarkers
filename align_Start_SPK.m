...
function  align_results=align_Start_SPK(data_folder,file2load, w2load, start_IC,chs2align)
...
for kch=1:numel(chs2align)
        ...
        for k=1:numel(labels_exe)
            ini=round((locs_start(k)-0.31)*fs_raw);
